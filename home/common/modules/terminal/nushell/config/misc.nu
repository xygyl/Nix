...
$env.PATH = (
    ...
    | prepend $"($env.HOME)/Documents/bin"
    | prepend $"($env.HOME)/.local/share/flatpak/exports/share"
)
...
$env.config = {
    ...
    keybindings: [
        ...
        {
            name: delete_char_forward_ctrl_delete
            modifier: control
            keycode: delete
            mode: [emacs, vi_insert]
            event: { edit: delete }
        ...
        {
            name: delete_char_backward_ctrl_h
            modifier: control
            keycode: char_h
            mode: [emacs, vi_insert]
            event: { edit: backspace }
        ...
        {
            name: delete_word_backward_ctrl_w
            modifier: control
            keycode: char_w
            mode: [emacs, vi_insert]
            event: { edit: backspaceword }
        ...
        {
            name: delete_word_backward_alt_backspace
            modifier: alt
            keycode: backspace
            mode: emacs
            event: { edit: backspaceword }
        ...
        {
            name: delete_word_backward_alt_m
            modifier: alt
            keycode: char_m
            mode: emacs
            event: { edit: backspaceword }
